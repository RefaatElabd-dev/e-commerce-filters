        ...
        return (
            <div className="card col-5 p-3 my-2 border-0 shadow" >
                <div className="card-body">
                    <p className="card-title text-center badge bg-danger p-2 rounded">{this.state.name}</p> 
                    <br/>
                    <sub className="fw-light text-muted">{this.state.releaseDate.substring(0, 10)}</sub>
                </div>
                <div className="text-center w-100">
                    <img src={this.state.image} className="iimg rounded-circle w-50 d-flex justify-content-center" alt="..." />
                </div>
                <div className="card-body row justify-content-evenly">
                    ...
                    <h4 className="col col-md-4">
                        <span className="badge rounded-pill align-middle bg-light text-dark border border-1 border-muted">
                            Color: <i class="fas fa-circle" style={{color:this.state.color}}></i>
                        </span>
                    </h4>
                </div>
                <div className="card-body row justify-content-evenly">
